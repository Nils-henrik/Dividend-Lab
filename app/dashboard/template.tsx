...
export default function DashboardTemplate({ children }: Props) {
  ...
  return (
    <>
      {showTicker && (
        <>
          <div className="absolute left-20 right-0 top-24 z-20 hidden h-[48px] overflow-hidden lg:block xl:right-72">
            <MarketTickerTape />
          </div>
          <div aria-hidden="true" className="hidden h-[62px] lg:block" />
