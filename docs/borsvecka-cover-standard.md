...
Den fotobaserade omslagsbilden för `public/news-demo/borsvecka-33.svg` är den visuella referensen för framtida artiklar i serien **Börsvecka**.
...
Canonical visual reference: `public/news-demo/borsvecka-33.svg`.
