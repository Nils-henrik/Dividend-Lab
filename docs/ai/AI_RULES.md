...
If the task touches roadmap, data, APIs, product decisions or AI behavior, also read the relevant docs in `docs/project/` and `docs/ai/`.

Start at `docs/README.md` if you are unfamiliar with the documentation structure.
...
For interaction and motion rules, see `standards/UI_UX_STANDARD.md`.
...
See `standards/ARCHITECTURE_STANDARD.md` and `standards/NAMING_CONVENTION.md` for full guidance.
