...
Use existing transition patterns such as:
...
Preserve the desktop premium SaaS experience.

Use responsive Tailwind patterns already present in the project:

- `md:`
- `lg:`
- `xl:`
- grid columns that collapse naturally
- hidden desktop-only previews where appropriate
