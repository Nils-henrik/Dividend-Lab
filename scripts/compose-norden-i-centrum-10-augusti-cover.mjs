/**
 * Compose DivLab Börsnyheter cover for Norden i centrum, 10 Augusti 2026.
 *
 ...
 *
 * Visual reference: public/news-demo/norden-i-centrum-7-augusti-2026.webp
 * Implementation reference: scripts/compose-norden-i-centrum-7-augusti-cover.mjs
 *
 * Usage: node scripts/compose-norden-i-centrum-10-augusti-cover.mjs
 */
...
const outputPath = join(
  root,
  "public/news-demo/norden-i-centrum-10-augusti-2026.webp",
);
...
const PANELS = [
  {
    name: "Nilörngruppen",
    caption: "Nilörngruppen gör sista handelsdagen",
    file: "norden10-panel-nilorn.png",
  },
  {
    name: "Equinor",
    caption: "Equinor stöds av oljeuppgången",
    file: "norden10-panel-equinor.png",
  },
  {
    name: "Aker BP",
    caption: "Aker BP mäter Hormuzrisken",
    file: "norden10-panel-akerbp.png",
  },
  {
    name: "Vår Energi",
    caption: "Vår Energi följer oljepriset",
    file: "norden10-panel-varenergi.png",
  },
  {
    name: "Novo Nordisk",
    caption: "Novo Nordisk söker fotfäste",
    file: "norden10-panel-novo.png",
  },
  {
    name: "Nokia",
    caption: "Nokia väger på räntesynen",
    file: "norden10-panel-nokia.png",
  },
];
...
<svg xmlns="http://www.w3.org/2000/svg" width="${WIDTH}" height="${HEIGHT}" viewBox="0 0 ${WIDTH} ${HEIGHT}">
  ...
  <text x="${WIDTH / 2}" y="${HEADER_H + 47}" text-anchor="middle" fill="${BLUE}"
    font-family="${SANS}" font-size="12" font-weight="700" letter-spacing="2.4">10 AUGUSTI</text>
...
async function main() {
  ...
  // Bias crop toward the waterfront buildings so the header matches the
  // established 7 August composition (less empty sky, more skyline).
  const skyline = await sharp(join(assetsDir, "norden10-skyline.png"))
