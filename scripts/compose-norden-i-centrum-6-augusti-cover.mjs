/**
 * Compose DivLab Börsnyheter cover for Norden i centrum, 6 Augusti 2026.
 *
 ...
 *
 * Usage: node scripts/compose-norden-i-centrum-6-augusti-cover.mjs
 */
...
const outputPath = join(
  root,
  "public/news-demo/norden-i-centrum-6-augusti-2026.webp",
);
...
const PANELS = [
  {
    name: "Yubico",
    caption: "Yubico återfår lönsamheten",
    file: "norden6-panel-yubico.png",
  },
  {
    name: "Lundin Mining",
    caption: "Lundin Mining levererar starkt kassaflöde",
    file: "norden6-panel-lundin.png",
  },
  {
    name: "Nordic Semiconductor",
    caption: "Nordic Semiconductor växer 33 procent",
    file: "norden6-panel-nordic.png",
  },
  {
    name: "Hexagon Composites",
    caption: "Hexagon Composites höjer prognosen",
    file: "norden6-panel-hexagon.png",
  },
  {
    name: "CapMan",
    caption: "CapMan tar in rekordkapital",
    file: "norden6-panel-capman.png",
  },
  {
    name: "Novo Nordisk",
    caption: "Novo Nordisk jagar förtroende",
    file: "norden6-panel-novo.png",
  },
];
...
<svg xmlns="http://www.w3.org/2000/svg" width="${WIDTH}" height="${HEIGHT}" viewBox="0 0 ${WIDTH} ${HEIGHT}">
  ...
  <text x="${WIDTH / 2}" y="${HEADER_H + 47}" text-anchor="middle" fill="${BLUE}"
    font-family="${SANS}" font-size="12" font-weight="700" letter-spacing="2.4">6 AUGUSTI</text>
...
async function main() {
  ...
  const skyline = await sharp(join(assetsDir, "norden6-skyline.png"))
