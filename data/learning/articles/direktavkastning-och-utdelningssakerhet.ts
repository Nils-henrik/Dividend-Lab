...
const article: LearningArticle = {
  ...
  description:
    "Varför hög avkastning inte räcker — och vad som ofta avgör om en utdelning är hållbar över tid för långsiktiga investerare.",
  excerpt:
    "Hållbar utdelning bygger på kassaflöde, affärskvalitet och förmågan att behålla utdelningen genom olika marknadslägen.",
  intro:
  ...
  sections: [
    {
      heading: "Vad direktavkastning mäter — och inte mäter",
      paragraphs: [
    ...
    {
      heading: "Utdelningssäkerhet: kvalitet före siffra",
      subsections: [
        {
          subheading: "Kassaflöde och utdelningsandel",
          paragraphs: [
        ...
        {
          subheading: "Affärskvalitet och bransch",
          paragraphs: [
    ...
    },
    {
      ...
      calculation: {
        title: "Exempel: tillväxt kontra hög nivå (förenklat)",
        lines: [
    ...
    {
      heading: "Risk, diversifiering och portföljens utdelningsström",
      subsections: [
        {
        ...
        {
          subheading: "Spridning över tid och sektor",
          paragraphs: [
      ...
      relatedLinks: [
        {
          ...
          text: "Hur direktavkastning påverkar tiden till ekonomisk frihet",
        },
      ],
    },
    {
      heading: "Vanliga fallgropar för utdelningsinvesterare",
      subsections: [
        {
          subheading: "Yield-fällan",
          paragraphs: [
        ...
        {
          subheading: "För snabb optimering",
          paragraphs: [
    ...
    {
      heading: "Praktiska frågor för långsiktiga investerare",
      paragraphs: [
