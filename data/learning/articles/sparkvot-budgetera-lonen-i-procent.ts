...
const article: LearningArticle = {
  ...
  title: "Så budgeterar du lönen i procent – en guide till sparkvot",
  seoTitle: "Sparkvot: så budgeterar du lönen i procent",
  description:
    "Lär dig fördela nettolönen mellan boende, buffert, långsiktigt sparande, pension, resor och vardag med en enkel procentbudget.",
  excerpt:
    "Hur mycket av lönen bör gå till boende, sparande, pension, resor och nöjen? Här får du en enkel procentmodell som hjälper dig att ge varje krona ett tydligt uppdrag.",
  ...
  sections: [
    {
      ...
      calculation: {
        title: "Formel",
        lines: ["Sparkvot = månadens sparande ÷ nettolönen × 100"],
      },
    },
    {
      paragraphs: [
      ...
      calculation: {
        title: "Exempel",
        lines: ["4 500 ÷ 30 000 × 100 = 15 procent"],
      },
    },
    {
      paragraphs: ["Till det långsiktiga sparandet kan du exempelvis räkna:"],
      bullets: [
    ...
    {
      heading: "En möjlig procentmodell för lönen",
      paragraphs: ["En månadsbudget skulle kunna fördelas så här:"],
      table: {
        headers: ["Område", "Andel av nettolönen"],
        rows: [
          ["Hem och boende", "30 %"],
          ["Mat och hushåll", "15 %"],
    ...
    {
      heading: "Exempel med 30 000 kronor efter skatt",
      paragraphs: [
        "Med en nettolön på 30 000 kronor skulle modellen kunna se ut så här:",
      ],
      table: {
        headers: ["Område", "Procent", "Kronor per månad"],
        rows: [
    ...
    {
      heading: "Hem och boende: omkring 30 procent",
      paragraphs: [
      ...
      subsections: [
        {
          subheading: "Ska amortering räknas som boendekostnad eller sparande?",
          paragraphs: [
    ...
    {
      heading: "Mat och hushåll: omkring 15 procent",
      paragraphs: [
    ...
    {
      heading: "Transport och fasta kostnader: omkring 10 procent",
      paragraphs: ["Den här kategorin kan innehålla:"],
      bullets: [
        "kollektivtrafik",
        "bilkostnader",
        "drivmedel",
    ...
    {
      heading: "Buffert: börja med omkring 5 procent",
      paragraphs: [
    ...
    {
      heading: "Långsiktigt sparande: sikta på 10–20 procent",
      paragraphs: [
    ...
    {
      heading: "Privat pension: behöver alla spara tio procent?",
      paragraphs: [
      ...
      subsections: [
        {
          subheading: "När kan tio procent till pension vara rimligt?",
          paragraphs: [
    ...
    {
      heading: "Resekonto och andra målkonton: omkring 10 procent",
      paragraphs: [
    ...
    {
      heading: "Nöjen och flexibel konsumtion: omkring 10 procent",
      paragraphs: [
    ...
    },
    {
      ...
      subsections: [
        ...
        {
          subheading: "När boendet är dyrt",
          paragraphs: [
        ...
        {
          subheading: "När du har dyra skulder",
          paragraphs: [
    ...
    {
      heading: "Automatisera fördelningen på lönedagen",
      paragraphs: [
    ...
    },
    {
      ...
      subsections: [
        {
          subheading: "Att sätta en för hög sparkvot direkt",
          paragraphs: [
        ...
        {
          subheading: "Att räkna resekontot som långsiktigt sparande",
          paragraphs: [
        ...
        {
          subheading: "Att investera hela bufferten",
          paragraphs: [
        ...
        {
          subheading: "Att pensionsspara utan att kontrollera tjänstepensionen",
          paragraphs: [
        ...
        {
          subheading: "Att glömma oregelbundna kostnader",
          paragraphs: [
    ...
    {
      heading: "Så kommer du i gång",
      paragraphs: ["Börja med de senaste tre månadernas kontoutdrag."],
      numberedItems: [
    ...
    },
    {
      ...
      paragraphs: ["En bra procentbudget ska göra tre saker samtidigt:"],
      bullets: [
        "betala för livet du lever i dag",
        "skydda dig mot oväntade kostnader",
        "bygga större ekonomisk frihet inför framtiden",
      ],
      paragraphsAfterLists: ["En möjlig utgångspunkt är att lägga:"],
    },
    {
      bullets: [
    ...
    },
    {
      ...
      subsections: [
        {
          subheading: "Hur stor sparkvot bör man ha?",
          paragraphs: [
        ...
        {
          subheading: "Räknas bufferten in i sparkvoten?",
          paragraphs: [
        ...
        {
          subheading: "Räknas amortering som sparande?",
          paragraphs: [
        ...
        {
          subheading: "Ska alla pensionsspara privat?",
          paragraphs: [
            "Nej.",
        ...
        {
          subheading: "Är resesparande en del av sparkvoten?",
          paragraphs: [
        ...
        {
          subheading: "Vad gör jag om jag inte kan spara tio procent?",
          paragraphs: [
