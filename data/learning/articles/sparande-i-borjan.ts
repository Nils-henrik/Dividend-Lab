...
const article: LearningArticle = {
  ...
  description:
    "Hur insättningar, vanor och tålamod formar resan innan portföljen vuxit sig stor — och varför de första åren ofta avgör mer än dagliga marknadsrörelser.",
  excerpt:
    "När kapitalet är relativt litet påverkar dina egna beslut mer än passiv avkastning — och vanor från början följer med i decennier.",
  intro:
  ...
  sections: [
    {
      ...
      calculation: {
        title: "Exempel: insättning kontra avkastning (år 1)",
        lines: [
    ...
    {
      heading: "Vanor som håller över decennier",
      subsections: [
        {
          subheading: "Automatisering och konsekvens",
          paragraphs: [
        ...
        {
          subheading: "Realistiska förväntningar",
          paragraphs: [
    ...
    {
      heading: "När avkastningen gradvis tar över",
      paragraphs: [
      ...
      relatedLinks: [
        {
          ...
          text: "Vad påverkar tiden till ekonomisk frihet mest?",
        },
        {
          slug: "direktavkastning-och-utdelningssakerhet",
          text: "Direktavkastning och utdelningssäkerhet",
        },
      ],
    },
    {
      heading: "Små beslut som blir stora över tid",
      paragraphs: [
      ...
      subsections: [
        {
          subheading: "Buffert före aggressivitet",
          paragraphs: [
    ...
    },
    {
      ...
      subsections: [
        {
          subheading: "Långsiktighet som konkurrensfördel",
          paragraphs: [
        ...
        {
          subheading: "Utbildning före komplexitet",
          paragraphs: [
