...
const article: LearningArticle = {
  slug: "barnsparande-2026-hur-mycket-ska-man-spara-till-barn",
  title: "650 kronor räcker – barnsparandet behöver inte bli en tävling",
  seoTitle: "Barnsparande 2026: hur mycket ska man spara till barn?",
  description:
    "Hur mycket ska man spara till barn 2026? DivLab går igenom svenska nivåer, barnbidraget och varför 650 kronor i månaden är ett rimligt riktmärke.",
  excerpt:
    "Hur mycket bör man spara till sitt barn? Svenska föräldrar sparar väldigt olika. DivLabs bedömning är att omkring 650 kronor i månaden är ett rimligt riktmärke för en familj med stabil ekonomi.",
  category: "Privatekonomi",
  publishedAt: "2026-08-26",
  updatedAt: "2026-08-26",
  authorName: "DivLab Redaktion",
  coverImage: "/learning/file_000000002114824680e92e86625294d9.png",
  coverImageAlt:
  ...
  sections: [
    {
      heading: "Hur mycket ska man spara till barn?",
      paragraphs: [
    ...
    {
      heading: "Hela barnbidraget är mycket pengar",
      paragraphs: [
    ...
    {
      heading: "650 kronor i månaden räcker långt",
      paragraphs: [
      ...
      relatedLinks: [
        {
          slug: "ranta-pa-ranta",
          text: "Läs också: Ränta på ränta – så växer pengar över tid",
        },
      ],
    },
    {
      heading: "Är det för sent att börja spara till barn vid 10 år?",
      paragraphs: [
    ...
    {
      heading: "Spara till barn i eget namn eller barnets namn?",
      paragraphs: [
      ...
      relatedLinks: [
        {
          ...
          text: "Läs också: ISK eller kapitalförsäkring – vad är skillnaden?",
        },
      ],
    },
    {
      heading: "Barnsparande ska hjälpa barnet – inte imponera på andra föräldrar",
      paragraphs: [
  ...
  sources: [
    {
      href: "https://www.lansforsakringar.se/49ed41/globalassets/aa-global/dokument/ovrigt/privatekonomi/barnspar.pdf",
      text: "Länsförsäkringar – Barnsparrapport 2025",
    },
    {
      href: "https://www.sbab.se/1/om_sbab/press/arkiv_publicering/pressmeddelande/2025-04-29_foraldrarnas_oro_halften_tror_inte_att_barnen_kommer_kunna_kopa_bostad_utan_hjalp.html",
      text: "SBAB – Barnfamiljsundersökning 2025",
    },
    {
      href: "https://blogg.avanza.se/hur-sparar-vara-juniorer-pa-avanza/",
      text: "Avanza – Så sparar andra till barnen",
    },
    {
      href: "https://www.forsakringskassan.se/privatperson/familj-och-barn/barnbidrag-och-flerbarnstillagg/barnbidrag-och-flerbarnstillagg-sa-funkar-det",
      text: "Försäkringskassan – Barnbidrag och flerbarnstillägg",
    },
    {
      href: "https://www.konsumenternas.se/konsumentstod/guider--checklistor/guider---sparande--pension/spara-till-barn/",
      text: "Konsumenternas – Spara till barn och barnbarn",
    },
  ],
