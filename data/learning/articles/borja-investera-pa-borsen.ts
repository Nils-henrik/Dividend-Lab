...
const article: LearningArticle = {
  ...
  title: "Börja investera på börsen – en steg-för-steg-guide för nybörjare",
  seoTitle: "Börja investera på börsen – guide för nybörjare 2026",
  description:
    "Lär dig börja investera på börsen steg för steg. Vi går igenom buffert, risk, ISK, fonder, aktier, avgifter och vanliga nybörjarmisstag.",
  excerpt:
  ...
  sections: [
    ...
    {
      heading: "2. Investera inte pengar som snart kan behövas",
      paragraphs: [
    ...
    {
      heading: "3. Bygg en buffert först",
      paragraphs: [
    ...
    {
      heading: "4. Se över dyra skulder",
      paragraphs: [
    ...
    {
      heading: "5. Bestäm varför du sparar",
      paragraphs: [
      ...
      subsections: [
        {
          subheading: "Vad ska pengarna användas till?",
        },
        {
          subheading: "När kan de tidigast behövas?",
        },
        {
          subheading: "Hur viktigt är det att hela beloppet finns tillgängligt just då?",
          paragraphsAfterLists: [
    ...
    {
      heading: "6. Förstå sambandet mellan risk och avkastning",
      paragraphs: [
    ...
    {
      heading: "7. Välj konto: ISK, kapitalförsäkring eller depå",
      paragraphs: [
        "I Sverige används framför allt tre former för börssparande.",
      ],
      subsections: [
        {
          subheading: "Investeringssparkonto – ISK",
          paragraphs: [
    ...
    {
      heading: "8. Välj en seriös bank eller nätmäklare",
      paragraphs: [
    ...
    {
      heading: "9. Fonder eller enskilda aktier?",
      paragraphs: [
        "Det är inte nödvändigt att välja bara det ena.",
      ],
      subsections: [
        {
          subheading: "En bred fond som grund",
          paragraphs: [
    ...
    {
      heading: "10. Riskspridning minskar beroendet av ett enskilt utfall",
      paragraphs: [
    ...
    {
      heading: "11. Håll koll på avgifterna",
      paragraphs: [
      ...
      subsections: [
        {
          subheading: "Läs fondens faktablad och kontrollera:",
          bullets: [
    ...
    {
      heading: "12. Så genomför du ditt första köp",
      paragraphs: [
    ...
    {
      heading: "13. Månadssparande gör processen enklare",
      paragraphs: [
    ...
    {
      heading: "14. Skriv en enkel investeringsplan",
      paragraphs: [
      ...
      subsections: [
        ...
        {
          subheading: "Regler för köp",
          paragraphs: [
            "När och hur investeras nya pengar?",
          ],
        },
        {
          subheading: "Regler för försäljning",
          paragraphs: [
    ...
    {
      heading: "15. Vanliga misstag när man börjar investera",
      subsections: [
        {
          subheading: "Att vänta på det perfekta läget",
          paragraphs: [
        ...
        {
          subheading: "Att börja med för många innehav",
          paragraphs: [
        ...
        {
          subheading: "Att köpa utifrån en kursgraf",
          paragraphs: [
        ...
        {
          subheading: "Att följa anonyma tips",
          paragraphs: [
    ...
    {
      heading: "16. En enkel 30-dagarsplan",
      subsections: [
        {
          subheading: "Vecka 1: Skapa grunden",
          bullets: [
        ...
        {
          subheading: "Vecka 2: Lär dig grunderna",
          bullets: [
        ...
        {
          subheading: "Vecka 3: Välj struktur",
          bullets: [
        ...
        {
          subheading: "Vecka 4: Börja försiktigt",
          bullets: [
    ...
    },
    {
      ...
      subsections: [
        {
          subheading: "Hur mycket pengar behövs för att börja?",
          paragraphs: [
        ...
        {
          subheading: "Är en global indexfond alltid bäst?",
          paragraphs: [
            "Nej.",
        ...
        {
          subheading: "Kan jag förlora alla pengar?",
          paragraphs: [
        ...
        {
          subheading: "Ska jag välja ISK eller kapitalförsäkring?",
          paragraphs: [
        ...
        {
          subheading: "Måste jag följa börsen varje dag?",
          paragraphs: [
            "Nej.",
