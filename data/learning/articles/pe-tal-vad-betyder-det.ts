...
const article: LearningArticle = {
  ...
  "title": "P/E-tal – vad betyder det och hur använder man det?",
  "seoTitle": "P/E-tal – vad betyder det och hur fungerar det?",
  "description": "Vad betyder P/E-tal? Lär dig hur P/E räknas ut, vad högt och lågt P/E kan säga och varför nyckeltalet aldrig bör användas ensamt.",
  "excerpt": "P/E-talet visar hur aktiekursen står i relation till bolagets vinst. Här lär du dig vad högt och lågt P/E kan betyda – och vilka vanliga fallgropar som finns.",
  "category": "Aktier",
  ...
  "sections": [
    {
      "heading": "Kort svar: vad betyder P/E?",
      "paragraphs": [
      ...
      "calculation": {"title": "Exempel", "lines": ["200 kr ÷ 10 kr = P/E 20"]},
      "paragraphsAfterLists": ["Marknaden värderar alltså aktien till 20 gånger vinsten per aktie."]
    },
    {
      "heading": "Vad betyder P/E 20?",
      "paragraphs": [
    ...
    },
    {
      ...
      "calculation": {
        "title": "P/E-formeln",
        "lines": ["240 kr ÷ 12 kr = P/E 20", "240 kr ÷ 20 kr = P/E 12"]
      },
      "paragraphsAfterLists": ["Samma aktiekurs kan alltså ge helt olika P/E-tal beroende på hur mycket bolaget tjänar."]
    },
    {
      "heading": "Är lågt P/E bra?",
      "paragraphs": [
        "Inte nödvändigtvis.",
    ...
    {
      "heading": "Det finns inget normalt P/E-tal som passar alla",
      "paragraphs": [
    ...
    {
      "heading": "Jämför gärna bolaget med sig självt",
      "paragraphs": [
    ...
    {
      "heading": "Vad är historiskt P/E och framåtblickande P/E?",
      "subsections": [
        {
          "subheading": "Historiskt P/E",
          "paragraphs": [
        ...
        {
          "subheading": "Framåtblickande P/E",
          "paragraphs": [
    ...
    {
      "heading": "Cykliska bolag kan lura P/E-talet",
      "paragraphs": [
    ...
    {
      "heading": "Vad händer om bolaget går med förlust?",
      "paragraphs": [
    ...
    {
      "heading": "Vinsten kan innehålla engångsposter",
      "paragraphs": [
    ...
    {
      "heading": "P/E säger nästan ingenting om skulder",
      "paragraphs": [
      ...
      "paragraphsAfterLists": ["Det är helheten som är intressant."]
    },
    {
      "heading": "Ett enkelt sätt att använda P/E",
      "paragraphs": [
    ...
    {
      "heading": "P/E-tal – sammanfattning",
      "paragraphs": [
  ...
  "sources": [
    {
      "href": "https://www.investor.gov/introduction-investing/investing-basics/glossary/price-earnings-pe-ratio",
      "text": "Investor.gov – Price-earnings (P/E) Ratio"
    }
  ]
};
