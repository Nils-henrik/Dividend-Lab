...
const article: LearningArticle = {
  "slug": "vad-ar-en-etf",
  "title": "Vad är en ETF? Så fungerar börshandlade fonder",
  "seoTitle": "Vad är en ETF? Så fungerar börshandlade fonder",
  "description": "Vad är en ETF och hur skiljer den sig från en vanlig fond? Lär dig om index, avgifter, spread, utdelningar och risker med börshandlade fonder.",
  "excerpt": "En ETF är en fond som handlas på börsen. Här förklarar vi hur ETF:er fungerar, hur de skiljer sig från vanliga fonder och vilka kostnader och risker du bör förstå.",
  "category": "Fonder",
  ...
  "sections": [
    {
      "heading": "Kort svar: vad är en ETF?",
      "paragraphs": [
    ...
    {
      "heading": "Är ETF samma sak som indexfond?",
      "paragraphs": [
        "Nej.",
      ...
      "paragraphsAfterLists": ["ETF och indexfond är därför inte synonymer."]
    },
    {
    ...
    {
      "heading": "ETF:er handlas under dagen",
      "paragraphs": [
    ...
    {
      "heading": "Spread – en kostnad som är lätt att missa",
      "paragraphs": [
    ...
    {
      "heading": "Vad kostar en ETF?",
      "subsections": [
        {"subheading": "Fondavgift", "paragraphs": ["ETF:en har normalt en löpande avgift som dras ur fondens värde."]},
        {"subheading": "Courtage", "paragraphs": ["Eftersom ETF:en köps på börsen kan banken eller nätmäklaren ta courtage."]},
        {"subheading": "Spread", "paragraphs": ["Skillnaden mellan köp- och säljkurs blir en indirekt handelskostnad."]},
        {"subheading": "Valutaväxling", "paragraphs": ["Om ETF:en handlas i en annan valuta än svenska kronor kan din bank ta betalt för valutaväxlingen."]}
      ],
      "paragraphsAfterLists": [
    ...
    {
      "heading": "Ackumulerande eller utdelande ETF",
      "paragraphs": ["ETF:er kan hantera utdelningar på olika sätt."],
      "subsections": [
        {
          "subheading": "Utdelande ETF",
          "paragraphs": [
    ...
    {
      "heading": "Fysisk och syntetisk replikering",
      "paragraphs": [
        "Om en ETF ska följa ett index behöver fonden på något sätt återskapa indexets utveckling.",
        "Det kan göras på flera sätt."
      ],
      "subsections": [
        {"subheading": "Fysisk ETF", "paragraphs": ["En fysisk ETF köper hela eller delar av de värdepapper som finns i indexet."]},
        {
          "subheading": "Syntetisk ETF",
          "paragraphs": [
    ...
    {
      "heading": "Valutan kan vara mer komplicerad än den ser ut",
      "paragraphs": [
    ...
    {
      "heading": "UCITS – en vanlig märkning på europeiska ETF:er",
      "paragraphs": [
    ...
    {
      "heading": "Varför går vissa utländska ETF:er inte att köpa?",
      "paragraphs": [
    ...
    {
      "heading": "En bred ETF behöver inte vara lika bred som den låter",
      "paragraphs": [
      ...
      "paragraphsAfterLists": ["Det är därför viktigt att kontrollera vilket index fonden faktiskt följer och vilka de största innehaven är."]
    },
    {
      "heading": "Tematiska ETF:er kan vara betydligt smalare",
      "paragraphs": ["Det finns ETF:er för nästan allt:"],
      "bullets": [
    ...
    {
      "heading": "Vad bör man kontrollera i en ETF?",
      "numberedItems": [
    ...
    {
      "heading": "ETF på ISK eller kapitalförsäkring",
      "paragraphs": [
      ...
      "relatedLinks": [
        {"slug": "isk-eller-kapitalforsakring", "text": "Läs mer om skillnaden mellan ISK och kapitalförsäkring"}
      ]
    },
    {
      "heading": "ETF – sammanfattning",
      "paragraphs": [
  ...
  "sources": [
    {
      ...
      "text": "Investor.gov – Exchange-Traded Funds (ETFs)"
    },
    {
      ...
      "text": "Europeiska kommissionen – Key information documents for PRIIPs"
    }
  ]
};
