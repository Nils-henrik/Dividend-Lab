...
const article: LearningArticle = {
  ...
  description:
    "En genomgång av sparande, avkastning, utdelningar och tålamod — och varför små optimeringar ofta betyder mindre än du tror i början av resan.",
  excerpt:
    "Månadssparande, realistiska antaganden och konsekvent tålamod påverkar ofta resans längd mer än marginella skillnader i avkastning.",
  intro:
  ...
  sections: [
    {
      heading: "Tre krafter som driver resan",
      intro: [
      ...
      subsections: [
        {
          subheading: "Insättningar som grund",
          paragraphs: [
        ...
        {
          subheading: "Tillväxt och återinvestering",
          paragraphs: [
    ...
    {
      heading: "Vad direktavkastning faktiskt betyder för tiden",
      paragraphs: [
      ...
      calculation: {
        title: "Exempel: kapitalbehov vid olika direktavkastning",
        lines: [
      ...
      relatedLinks: [
        {
          ...
          text: "Läs mer om direktavkastning och utdelningssäkerhet",
        },
      ],
    },
    {
      heading: "Sparandets effekt på tiden — ett enkelt scenario",
      subsections: [
        {
          subheading: "När insättningarna gör skillnaden",
          paragraphs: [
        ...
        {
          subheading: "När avkastningen börjar ta över",
          paragraphs: [
      ...
      relatedLinks: [
        {
          ...
          text: "Varför sparandet betyder mest i början",
        },
      ],
    },
    {
      heading: "Scenarier, uppföljning och lugn justering",
      subsections: [
        {
          subheading: "Bygg flera antaganden",
          paragraphs: [
        ...
        {
          subheading: "Uppföljning utan panik",
          paragraphs: [
    ...
    {
      heading: "Disciplin, risk och realistiska förväntningar",
      paragraphs: [
