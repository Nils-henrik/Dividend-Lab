...
export const SINCH_RASAR_EFTER_Q2_RAPPORTEN_2026_ARTICLE: NewsArticle = {
  ...
  slug: "sinch-rasar-efter-q2-rapporten-2026",
  title: "Sinch rasar efter rapporten – aktien ned 13 procent",
  summary:
  ...
  seoDescription:
    "Sinch faller kraftigt på Stockholmsbörsen efter rapporten för andra kvartalet. Lägre marginaler och svaghet i APAC överskuggar tillväxten.",
  seoKeywords: [
    "Sinch",
    "Q2",
    "kvartalsrapport",
  ...
  sections: [
    {
      heading: "Sinchs rapport i korthet",
      paragraphs: [
    ...
    {
      heading: "Därför faller Sinch-aktien",
      paragraphs: [
    ...
    {
      heading: "Stark utveckling i Americas",
      paragraphs: [
    ...
    {
      heading: "Starkare kassaflöde men högre skuld",
      paragraphs: [
    ...
    {
      heading: "Det bevakar marknaden framöver",
      paragraphs: [
