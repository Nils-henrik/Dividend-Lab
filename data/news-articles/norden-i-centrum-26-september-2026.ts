...
/**
 * Norden i centrum — 26 september 2026.
 ...
 * P0_SOURCE[primary]: https://www.norges-bank.no/aktuelt/nyheter/Pressemeldinger/2026/2026-09-24-rente/
 * P0_SOURCE[primary]: https://www.novonordisk.com/news-and-media/news-and-ir-materials/news-details.html?id=916773
 * P0_SOURCE[primary]: https://stat.fi/sv/publikation/cmfgj5cnd80co07vxcv52plyc
 */
export const NORDEN_I_CENTRUM_26_SEPTEMBER_2026_ARTICLE: NewsArticle = {
  id: "norden-i-centrum-26-september-2026",
  slug: "norden-i-centrum-26-september-2026",
  title: "Norden i centrum – veckan som gått: H&M, Novo och dubbla räntebesked",
  summary:
  ...
  seoDescription:
    "Veckan som gått i Norden: H&M:s Q3, Riksbankens besked, Norges Banks höjning, Novo Nordisks kapitalmarknadsdag och finska producentpriser.",
  seoKeywords: [
    "nordiska börser veckan som gått",
    "H&M rapport Q3 2026",
  ...
  internalLinking: {
    topics: ["Norden", "Sverige", "Norge", "Danmark", "Finland", "ränta", "inflation", "läkemedel", "detaljhandel"],
    companies: ["H&M", "Novo Nordisk"],
    tickers: ["HM B", "NOVO B"],
    relatedNewsSlugs: ["norden-i-centrum-24-september-2026", "borssverige-24-september-2026", "norden-i-centrum-23-september-2026"],
  },
  showDisclaimer: true,
  intro: [
  ...
  sections: [
    {
      heading: "H&M: starkare lönsamhet blev veckans stora svenska bolagsbesked",
      paragraphs: [
    ...
    {
      heading: "Riksbanken stod still – men signalen blev stramare",
      paragraphs: [
    ...
    {
      heading: "Norges Bank höjde till 4,50 procent",
      paragraphs: [
    ...
    {
      heading: "Novo Nordisk flyttade blicken mot 2030",
      paragraphs: [
    ...
    {
      heading: "Finland: producentpriserna steg 7,3 procent",
      paragraphs: [
    ...
    {
      heading: "DivLabs blick: tre saker att bära med sig från vecka 39",
      paragraphs: [
  ...
  sources: [
    ...
    {
      text: "Norges Bank: Styringsrenten settes opp til 4,50 prosent, 24 september 2026",
      href: "https://www.norges-bank.no/aktuelt/nyheter/Pressemeldinger/2026/2026-09-24-rente/",
    },
    {
      text: "Novo Nordisk: Highlights to be presented at Novo’s Capital Markets Day 2026, 21 september 2026",
      href: "https://www.novonordisk.com/news-and-media/news-and-ir-materials/news-details.html?id=916773",
    },
    {
      text: "Statistikcentralen: Producentpriserna för industrin steg 7,3 procent i augusti 2026",
      href: "https://stat.fi/sv/publikation/cmfgj5cnd80co07vxcv52plyc",
    },
  ],
};
