...
/** Approved BörsSverige Lunch article — 13 August 2026. */
export const BORSSVERIGE_LUNCH_13_AUGUSTI_2026_ARTICLE: NewsArticle = {
  id: "borssverige-lunch-13-augusti-2026",
  slug: "borssverige-lunch-13-augusti-2026",
  title: "BörsSverige Lunch – 13 augusti: Embracer rusar efter rapporten",
  summary:
  ...
  sections: [
    {
      heading: "Embracer slår förväntningarna med bred marginal",
      paragraphs: [
    ...
    {
      heading: "Gothic blev kvartalets stora motor",
      paragraphs: [
    ...
    {
      heading: "Flera år av omställning börjar synas",
      paragraphs: [
    ...
    {
      heading: "Prognosen ligger fast – men förtroendet har ökat",
      paragraphs: [
    ...
    {
      heading: "Vad marknaden behöver se härnäst",
      paragraphs: [
    ...
    {
      heading: "En annan svensk ljuspunkt: RaySearchs order och kassaflöde",
      paragraphs: [
