...
export const NORDEN_I_CENTRUM_10_AUGUSTI_2026_ARTICLE: NewsArticle = {
  ...
  slug: "norden-i-centrum-10-augusti-2026",
  title: "Norden i centrum, 10 Augusti",
  summary:
  ...
  seoDescription:
    "Norden och börsen idag den 10 augusti 2026: oljan och Hormuz styr riskbilden, Novo Nordisk söker fotfäste och Nilörngruppen gör sista handelsdagen.",
  seoKeywords: [
    "Norden",
    "börsen idag",
    "Stockholmsbörsen",
  ...
  sections: [
    {
      heading: "Halva börsdagen: oljan håller Norden på helspänn",
      paragraphs: [
    ...
    {
      heading: "Sverige: sista handelsdagen för Nilörngruppen",
      paragraphs: [
    ...
    {
      heading: "Norge: Hormuz gör energibolagen till temperaturmätare",
      paragraphs: [
    ...
    {
      heading: "Finland: räntor och teknik väger tyngre än rapportfloden",
      paragraphs: [
    ...
    {
      heading: "Danmark: Novo Nordisk söker en ny jämviktsnivå",
      paragraphs: [
    ...
    {
      heading: "Hög risk: Induct går mot emissionsdeadline",
      paragraphs: [
    ...
    {
      heading: "Det här styr resten av dagen",
      paragraphs: [
