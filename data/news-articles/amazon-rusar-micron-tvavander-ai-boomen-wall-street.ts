    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "På fredagen steg Amazon omkring 15 procent. Micron, som dagen innan rusat omkring 18 procent, vände ned med ungefär 6 procent. Siffrorna speglar stämningen mer än någon plötslig förändring i den underliggande AI-efterfrågan.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Molnverksamheten ökade med 37 procent till 42,2 miljarder dollar – den snabbaste tillväxten på 18 kvartal. Det gav investerarna större förtroende för att Amazons massiva AI-satsningar inte bara är dyra framtidsprojekt, utan redan bidrar till ökade intäkter.",
          ...
          "De största amerikanska teknikbolagen investerar tillsammans enorma belopp i datacenter, elförsörjning, nätverk, AI-chip och minne. Oron har varit att kostnaderna ska öka snabbare än kundernas betalningsvilja.",
          "Amazons rapport gav stöd åt motsatsen. Efterfrågan på molnkapacitet och AI-tjänster är fortsatt hög, samtidigt som bolaget fortfarande arbetar med att bygga ut tillräcklig kapacitet. Budskapet till marknaden var tydligt: Amazon spenderar mycket pengar, men kunderna verkar redan finnas där.",
        ],
      },
      {
        heading: "Investeringarna fortsätter att växa",
        paragraphs: [
          "Amazon planerar samtidigt att fortsätta investera kraftigt i datacenter och AI-infrastruktur. Bolaget räknar med investeringar på omkring 220 miljarder dollar under 2026.",
          "Det innebär högre kostnader för servrar, nätverksutrustning, avancerade processorer och minneskretsar. Det fria kassaflödet – pengarna som blir kvar efter att bolaget betalat de investeringar som krävs för verksamheten – var negativt med 7,6 miljarder dollar under de senaste tolv månaderna, jämfört med ett plus på 18,2 miljarder dollar året innan.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "I det senaste rapporterade kvartalet, som avslutades den 28 maj, redovisade Micron intäkter på 41,5 miljarder dollar. Bruttomarginalen – andelen av försäljningen som blir kvar efter de direkta tillverkningskostnaderna – låg omkring 85 procent. Det är ett helt annat marknadsläge än under tidigare perioder med överproduktion och fallande priser.",
      ...
      },
      {
        ...
        paragraphs: [
          "En förklaring är vanlig vinsthemtagning efter en mycket kraftig uppgång.",
          "Men marknaden funderar också över hur länge dagens höga minnespriser kan hålla.",
          ...
          "Apples vd Tim Cook beskrev i bolagets rapport den 30 juli läget som en extrem prispress på minnesmarknaden och pekade på att utbudet i praktiken styrs av ett fåtal stora leverantörer. När priserna stiger kraftigt ökar kundernas motivation att hitta fler leverantörer, förhandla hårdare, använda minnet effektivare eller utveckla alternativa tekniska lösningar.",
          "Dagens starka efterfrågan kan därför tolkas på två sätt.",
          "Den visar att Micron har goda möjligheter att tjäna mycket pengar. Men den ökar också risken för att kunder, konkurrenter och nya investeringar på sikt förändrar balansen mellan tillgång och efterfrågan.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Amazon belönas när bolaget kan visa tydlig tillväxt och stigande resultat från AWS. Micron pressas när investerarna börjar fråga hur länge den exceptionella lönsamheten på minnesmarknaden kan bestå.",
          "Framöver bevakar investerarna särskilt om Amazons molntillväxt håller i sig trots de stora utgifterna, och om Microns höga priser och marginaler klarar nästa rapportperiod utan att efterfrågan eller kundernas betalningsvilja börjar svikta.",
          "Så länge AI-datacentren fortsätter att byggas kommer båda bolagen att stå i centrum för marknadens uppmärksamhet.",
          "Men veckans dramatiska kursrörelser visar också hur höga förväntningarna har blivit. När investerarna redan räknar med snabb tillväxt och rekordstora investeringar kan minsta tvekan flytta enorma börsvärden på bara några timmar.",
        ],
      },
    ],
  };
