...
/**
 * Hufvudstaden half-year report — 20 August 2026.
 *
 * Editorial angle: what the report says about prime commercial property,
 * rental demand and the split between Stockholm and Gothenburg.
 *
 * Verified editorial anchors:
 * - Hufvudstaden half-year report January–June 2026.
 * - Hufvudstaden investor/press material on Stockholm and Gothenburg leasing.
...
export const HUFVUDSTADEN_TOPPLAGEN_VINNER_NAR_VARDENA_VANDER_20_AUGUSTI_2026_ARTICLE: NewsArticle = {
  ...
  slug: "hufvudstaden-topplagen-vinner-nar-vardena-vander-20-augusti-2026",
  title: "Hufvudstaden trotsar fastighetssvackan – topplägen vinner när värdena vänder",
  summary:
  ...
  imageAlt:
    "DivLab-omslag om Hufvudstaden och fastighetsmarknaden med en AI-genererad gestaltning av Norrmalmstorg 1 i Stockholm.",
  imageCaption:
    "AI-illustration: DivLab. Bilden är en AI-genererad gestaltning av Hufvudstadens fastighet vid Norrmalmstorg 1.",
  readingMinutes: 6,
  seoTitle: "Hufvudstaden: topplägen vinner när fastighetsvärdena vänder",
  seoDescription:
    "Hufvudstadens Q2 visar stigande förvaltningsresultat, lägre vakans och stabilare fastighetsvärden. DivLab analyserar varför topplägen drar ifrån.",
  seoKeywords: [
    "Hufvudstaden",
    "Hufvudstaden aktie",
    "Hufvudstaden Q2 2026",
    "fastighetsaktier",
    "kommersiella fastigheter",
    "kontorsmarknaden Stockholm",
    "Norrmalmstorg",
    "Bibliotekstan",
    "fastighetsvärden",
    "EPRA NRV",
  ...
  sections: [
    {
      heading: "Fastighetsvärdena börjar röra sig uppåt igen",
      paragraphs: [
    ...
    {
      heading: "Stockholm och Göteborg har blivit två olika marknader",
      paragraphs: [
    ...
    {
      heading: "Tomma lokaler blir färre",
      paragraphs: [
    ...
    {
      heading: "Miljardprojektet i Göteborg börjar fyllas",
      paragraphs: [
    ...
    {
      heading: "Även NK visar förbättring",
      paragraphs: [
    ...
    {
      heading: "Men allt är inte positivt",
      paragraphs: [
    ...
    {
      heading: "Börsen tror fortfarande inte fullt ut på fastigheterna",
      paragraphs: [
    ...
    {
      heading: "En återhämtning – men bara på rätt adress",
      paragraphs: [
