...
/**
 * Bolaget i fokus — 17 september 2026.
 * Editorial research cutoff: 2026-09-17T11:01:30+02:00
 * P0_FACT_GATE=PASS
 ...
 * P0_SOURCE[primary]: https://investors.volvocars.com/en/news-and-events/cmd
 * P0_SOURCE[secondary]: https://www.reuters.com/world/china/volvo-cars-launch-13-new-cars-this-decade-2026-09-17/
 */
export const BOLAGET_I_FOKUS_VOLVO_CARS_17_SEPTEMBER_2026_ARTICLE: NewsArticle = {
  id: "bolaget-i-fokus-volvo-cars-17-september-2026",
  slug: "bolaget-i-fokus-volvo-cars-17-september-2026",
  title: "Bolaget i fokus: Volvo Cars siktar på över 8 procents EBIT-marginal",
  summary: "Volvo Cars presenterar sin största produktoffensiv hittills med 13 nya elektrifierade modeller till 2030. Samtidigt siktar bolaget på en EBIT-marginal över 8 procent och större kostnadssynergier med Geely.",
  category: "company",
  source: "DivLab Redaktion",
  publishedAt: "2026-09-17T11:02:00+02:00",
  url: "/news/bolaget-i-fokus-volvo-cars-17-september-2026",
  featured: true,
  readingMinutes: 4,
  seoTitle: "Volvo Cars strategi 2026: mål om över 8% EBIT-marginal",
  seoDescription: "Volvo Cars lanserar 13 nya elektrifierade modeller till 2030 och siktar på en EBIT-marginal över 8 procent. Här är strategin bakom målen.",
  seoKeywords: ["Volvo Cars aktie", "VOLCAR B", "Volvo Cars strategi 2026", "Volvo Cars EBIT-marginal", "Volvo Cars 13 nya modeller", "Volvo Cars Geely", "17 september 2026"],
  internalLinking: {
    topics: ["fordonsindustri", "elektrifiering", "lönsamhet", "kapitalmarknadsdag"],
  ...
  sections: [
    {
      heading: "13 nya elektrifierade modeller till 2030",
      paragraphs: [
    ...
    {
      heading: "Målet: EBIT-marginal över 8 procent",
      paragraphs: [
    ...
    {
      heading: "Geely-synergier ska pressa materialkostnaderna",
      paragraphs: [
    ...
    {
      heading: "Aktien steg i tidig handel",
      paragraphs: [
  ...
  sources: [
    ...
    { text: "Volvo Cars Investor Relations: Strategy Update 17 september 2026", href: "https://investors.volvocars.com/en/news-and-events/cmd" },
    { text: "Reuters: Volvo Cars to launch 13 new models this decade, eyes earnings boost, 17 september 2026", href: "https://www.reuters.com/world/china/volvo-cars-launch-13-new-cars-this-decade-2026-09-17/" }
  ]
};
