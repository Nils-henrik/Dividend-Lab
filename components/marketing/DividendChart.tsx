...
const stats = {
  ...
  "5Å": {
    dividend: "158 400 kr",
    yield: "6.12%",
    income: "13 200 kr/mån",
  },

  "ALL": {
    dividend: "243 700 kr",
    yield: "7.04%",
    income: "20 308 kr/mån",
  },
};
...
export default function DividendChart() {
 ...
 const currentStats = stats[period as keyof typeof stats];
  return (
    <div className="mt-6 rounded-2xl border border-white/10 bg-[#161616] p-6">
...
<AreaChart data={chartData[period as keyof typeof chartData]}>            <defs>
