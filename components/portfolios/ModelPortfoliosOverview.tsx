...
function MiniSparkline({ accent, flat }: { accent: string; flat: boolean }) { return <svg aria-hidden="true" viewBox="0 0 112 44" className={`h-11 w-28 ${accent}`} fill="none"><path d={flat ? "M4 25 L108 25" : "M4 34 L16 28 L25 30 L35 22 L45 27 L57 14 L67 17 L78 10 L89 12 L99 7 L108 12"} stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg>; }
