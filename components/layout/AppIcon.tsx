...
const icons: Record<AppIconName, string> = {
  ...
  brain: "M8 6a3 3 0 0 1 5-2 3 3 0 0 1 5 2 3 3 0 0 1 1 5 3 3 0 0 1-1 5 3 3 0 0 1-5 2 3 3 0 0 1-5-2 3 3 0 0 1-1-5 3 3 0 0 1 1-5Zm4-2v16M8 10h8M8 14h8",
  calendar: "M7 3v4M17 3v4M4 8h16M5 5h14a1 1 0 0 1 1 1v14H4V6a1 1 0 0 1 1-1Zm3 7h3M13 12h3M8 16h3",
  ...
  gift: "M4 9h16v11H4V9m-1-4h18v4H3V5m9 0v15",
  goals: "M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0-4a5 5 0 1 0 0-10 5 5 0 0 0 0 10Zm0-3a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z",
  learning: "M4 6.5 12 3l8 3.5-8 3.5-8-3.5Zm3 3.5v5c0 1.7 2.2 3 5 3s5-1.3 5-3v-5",
  ...
  rocket: "M5 19l4-1 9-9 1-5-5 1-9 9-1 5Zm8-8 2 2",
  search: "m21 21-4.35-4.35M10.5 18a7.5 7.5 0 1 1 0-15 7.5 7.5 0 0 1 0 15Z",
  settings: "M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm0-12v3m0 11v3m8.5-8.5h-3m-11 0h-3m14.6-6.1-2.1 2.1M7.5 16.5l-2.1 2.1m0-12.7 2.1 2.1m9 8.5 2.1 2.1",
  shield: "M12 3l7 3v5c0 4-3 8-7 10-4-2-7-6-7-10V6l7-3",
  watchlist: "M12 3.5 14.7 9l6.1.9-4.4 4.3 1 6.1L12 17.4l-5.4 2.9 1-6.1-4.4-4.3 6.1-.9L12 3.5Z",
};

export default function AppIcon({ name, className = "h-4 w-4" }: Props) {
  return <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" className={className}><path d={icons[name]} /></svg>;
}
