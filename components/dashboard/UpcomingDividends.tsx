...
export default function UpcomingDividends() {
  return (
    <div className="rounded-2xl border border-white/10 bg-[#161616] p-6">
      <div className="mb-6">
        <h2 className="text-lg font-semibold text-white">Kommande utdelningar</h2>
        <p className="mt-2 text-sm text-gray-400">
          En fokuserad vy över de utbetalningar som är näst på tur.
        </p>
      </div>
      ...
      <div className="overflow-hidden rounded-xl border border-white/10">
        <table className="w-full border-collapse text-left text-sm">
          <thead className="bg-white/[0.03] text-xs uppercase tracking-[0.16em] text-gray-500">
            <tr>
              <th className="px-4 py-3 font-medium">Bolag</th>
              <th className="px-4 py-3 font-medium">Utbetalningsdatum</th>
