    ...
    <div className="space-y-3">
      ...
      <main className="space-y-3">
        <section className="divlab-card p-6">
          <p className="divlab-section-label">Välkommen</p>
          ...
          <p className="mt-4 max-w-3xl text-sm leading-7 text-gray-300">
            Forumet är DivLabs plats för långsiktiga investerare att diskutera,
            ställa frågor och lära av varandra. Här premieras saklighet,
            nyfikenhet, respekt och resonemang som hjälper andra att förstå.
          </p>
        </section>
        ...
        <section className="divlab-surface-panel p-6">
          <h2 className="text-sm font-semibold text-white">Uppföranderegler</h2>
        ...
        <section className="divlab-surface-panel p-6">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-7 text-gray-300">
            ...
            ärlig vilja att förstå är välkomna här. Det finns inga dumma frågor
            när målet är att lära sig, men försök gärna beskriva vad du redan
            har funderat på så blir svaren bättre.
          </p>
        </section>
        ...
        <section className="divlab-surface-panel p-6">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-7 text-gray-300">
            ...
            tolkas som individuell finansiell rådgivning eller som uppmaningar
        ...
        <section className="divlab-surface-panel p-6">
          ...
          <p className="mt-3 max-w-3xl text-sm leading-7 text-gray-300">
            För att skydda forumets kvalitet kan inlägg redigeras, döljas eller
            tas bort. Konton kan få en varning, begränsas eller stängas av vid
            upprepade eller allvarliga överträdelser. Målet är inte att straffa,
            utan att hålla forumet användbart, tryggt och värdefullt för
            seriösa medlemmar.
          </p>
        </section>
          ...
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-gray-400">
                När du är redo kan du gå vidare till kategorierna och börja läsa
                eller starta diskussioner.
              </p>
            </div>
            {isAuthenticated ? (
              <Link
              ...
              <Link
                href={`/login?redirect=${encodeURIComponent("/forum/kategorier")}`}
